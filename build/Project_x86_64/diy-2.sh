...
sed -i "s/OpenWrt /机器喵 build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/"KMS 服务器"/"微软产品激活"/g' package/lean/luci-app-vlmcsd/po/zh-cn/vlmcsd.zh-cn.po
sed -i 's/"TTYD 终端"/"命令窗"/g' package/lean/luci-app-ttyd/po/zh-cn/terminal.po
sed -i 's/"USB 打印服务器"/"打印机共享"/g' package/lean/luci-app-usb-printer/po/zh-cn/usb-printer.po
